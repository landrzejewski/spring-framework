...
import pl.training.payments.PaymentsFixtures;
...
class PercentagePaymentFeeCalculatorTest {
    ...
    void given_payment_value_when_calculate_fee_the_returns_percentage_of_the_payment_value() {
        ...
        var fee = calculator.calculateFee(PaymentsFixtures.PAYMENT_VALUE);
        Assertions.assertEquals(PaymentsFixtures.PAYMENT_VALUE.multiply(PERCENTAGE_VALUE), fee);
    }
