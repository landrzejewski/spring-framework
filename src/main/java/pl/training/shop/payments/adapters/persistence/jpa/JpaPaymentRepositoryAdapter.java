...
public class JpaPaymentRepositoryAdapter implements PaymentRepository {
    ...
    @Override
    public ResultPage<Payment> findByStatus(PaymentStatus status, Page page) {
        var result = repository.findByStatus(status.name(), PageRequest.of(page.getNumber(), page.getSize()));
