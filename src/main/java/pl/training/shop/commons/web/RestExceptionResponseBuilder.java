...
public class RestExceptionResponseBuilder {
    ...
    public String getLocalizedMessage(Exception exception, Locale locale, String...params) {
        var key = exception.getClass().getSimpleName();
        return messageSource.getMessage(key, params, DEFAULT_DESCRIPTION, locale);
    }
